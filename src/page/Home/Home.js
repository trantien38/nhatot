...
export default function Home() {
  return (
    <>
      <Slider />
      <Box sx={{display:'flex', padding:'20px', justifyContent:'center', backgroundColor:'#fff'}}>
        <Category
          icon={
      ...
      <Box sx={{maxWidth:'960px', margin:'auto'}}>
        <Box sx={{padding:'8px'}}>
          ...
          <p>Mua bán và cho thuê bất động sản được xem là một trong những hình thức kinh doanh siêu lợi nhuận, chính vì thế mà các hình thức kinh doanh bất động sản này đang được rất nhiều người quan tâm và đầu tư. Hãy cùng Nhà Tốt - chuyên trang bất động sản thuộc Chợ Tốt tìm hiểu kỹ hơn về các hình thức mua bán, cho thuê bất động sản ngay trên chuyên trang Nhatot.com.</p>
          <h3>Mua bán và cho thuê bất động sản là gì?</h3>
          <p>Kinh doanh bất động sản hiện nay đang là một trong những phương thức kinh doanh được rất nhiều nhà đầu tư hướng đến, sở dĩ kinh doanh bất động sản được nhiều người lựa chọn là do nó có thể mang tới cho các nhà đầu tư những khoản lợi nhuận siêu hấp dẫn, bởi vì vậy hình thức kinh doanh mua bán và cho thuê bất động sản là được nhiều nhà đầu tư lựa chọn nhất.</p>
        </Box>
        <Box></Box>
      </Box>
    </>
